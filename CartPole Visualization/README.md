...
1. Create a local copy of this repository (by cloning it via GitHub Desktop / [Git](https://git-scm.com/docs/git-clone), or by [downloading it as a `.ZIP` file](https://github.com/Harrow-Enigma/ai-lecture-series-summer21/archive/refs/heads/main.zip)). The latter is probably the simplest if you have had minimal experience with Git!
